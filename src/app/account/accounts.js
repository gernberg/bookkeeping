 ...
 */
.controller( 'AccountsCtrl', function AccountsController( $scope, AccountRes, $state, CompanyService, $rootScope, FiscalService) {
...
.factory( 'AccountRes', function ( $resource, AccountCache)  {
  ...
  return $resource('../companies/:cid/:extra/:fid/accounts/:id.json', {id: '@id', cid: '@cid', fid: '@fid'}, {'update': {method: 'PATCH'},
    'query': {
      cache: AccountCache,
      isArray: true
    },
