...
class VouchersControllerTest < ActionController::TestCase
  ...
  test "should create voucher" do
    assert_difference('Voucher.count') do
      post :create, voucher: { date: @voucher.date, fiscal_year_id: @voucher.fiscal_year_id, title: @voucher.title }
    end
  ...
  test "should update voucher" do
    patch :update, id: @voucher, voucher: { date: @voucher.date, fiscal_year_id: @voucher.fiscal_year_id, title: @voucher.title }
    assert_redirected_to voucher_path(assigns(:voucher))
  end
